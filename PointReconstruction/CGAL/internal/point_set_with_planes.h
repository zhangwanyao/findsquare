        ...
        namespace internal {
                ...
                */
                ...
                public:
                        ...
                        //UNRE
                        Planar_segment(Point_set* point_set,Plane* plane_set) : point_set_(point_set), supporting_plane_(plane_set) {}
                        //UNRE_end
                        ~Planar_segment() {}
                ...
                public:
                        ...
                        */
                        ...
                        )
                        {
                            ...
                            for (std::size_t i = 0; i < num_plane; ++i)
                                if (i < vectors.size()&&
									get(plane_index_map, vectors[i])>0)
                                {
                                    auto supporting_plane_ = new  Plane(get(point_map, vectors[i]), get(normal_map, vectors[i]));
                                    planar_segments_.push_back(new Planar_segment(this,
                                        supporting_plane_));
                                }
                                else
