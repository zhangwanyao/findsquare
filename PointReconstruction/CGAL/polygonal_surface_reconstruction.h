...
#include "internal/hypothesis.h"
#include "internal/compute_confidences.h"
#include "internal/point_set_with_planes.h"
...
namespace CGAL {
        ...
        */
                ...
                */
                ...
                bool reconstruct(
                       ...
                       // double wt_complexity = 0.30                ///< weight for the model complexity term.
						double wt_fitting = 0.3,                ///< weight for the data fitting term.
                       double wt_coverage = 0.3,                ///< weight for the point coverage term.
                        double wt_complexity = 0.4                ///< weight for the model complexity term.
						//double wt_fitting = 0.2,                ///< weight for the data fitting term.
	                   // double wt_coverage = 0.2,                ///< weight for the point coverage term.
	                  // double wt_complexity = 0.6                ///< weight for the model complexity term.
                );
        ...
        Polygonal_surface_reconstruction<GeomTraits>::Polygonal_surface_reconstruction(const PointRange& points,
            PointMap point_map, NormalMap normal_map, IndexMap index_map,
            const PointRange& vectors) : error_message_("")
        {
            if (points.empty()) {
                error_message_ = "empty input points";
                return;
            ...
            Point_set_with_planes point_set(points, point_map, normal_map, index_map, vectors);
